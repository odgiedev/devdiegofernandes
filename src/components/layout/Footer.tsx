...
export function Footer({
  ...
  return (
    <footer className="border-t border-border mt-16">
      <div className="mx-auto w-full max-w-3xl px-6 flex flex-col gap-4 py-8 text-sm text-muted sm:flex-row sm:items-center sm:justify-between">
        <p>
          © {new Date().getFullYear()} Diego Dev.
        </p>
        <ul className="flex flex-wrap items-center gap-4">
          ...
          <li>
            <a
              ...
              className="inline-flex items-center gap-1.5 hover:text-fg"
            >
              <LinkedInIcon /> {dict.footer.linkedin}
            </a>
          </li>
          <li>
            <a
              ...
              className="inline-flex items-center gap-1.5 hover:text-fg"
            >
              <Mail size={14} aria-hidden /> {dict.footer.email}
            </a>
          </li>
          <li>
            <a
              ...
              className="inline-flex items-center gap-1.5 hover:text-fg"
            >
              <FileText size={14} aria-hidden /> {dict.footer.resume}
            </a>
          </li>
        </ul>
      </div>
